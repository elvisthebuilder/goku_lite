...
class PersonalityManager:
    """Lightweight Persona Manager for Goku Lite."""
    ...
    def get_assigned_persona_name(self, source: str, session_id: str) -> str:
        mappings = self._load_mappings()
        # Priority: Specific Session > Generic Source > Default
        for key in [f"{source}:{session_id}", session_id, source]:
            if key in mappings:
                return mappings[key]
        return "CORE"
